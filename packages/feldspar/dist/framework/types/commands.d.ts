...
export type CommandSystem = CommandSystemDonate | CommandSystemEvent | CommandSystemExit;
...
export declare function isCommandSystemEvent(arg: any): arg is CommandSystemEvent;
export interface CommandSystemExit {
    __type__: 'CommandSystemExit';
    code: number;
    info: string;
}
export declare function isCommandSystemExit(arg: any): arg is CommandSystemExit;

...
export type PropsUI = PropsUIText | PropsUIButton | PropsUICheckBox | PropsUIRadioItem | PropsUINumberIcon | PropsUISpinner | PropsUIProgressBar | PropsUIPagination | PropsUIHeader | PropsUITable | PropsUITablePage | PropsUITableCard | PropsUITableCardItem | PropsUISearchBar | PropsUIPage | PropsUIPrompt;
...
export declare function isPropsUINumberIcon(arg: any): arg is PropsUINumberIcon;
...
export declare function isPropsUIProgress(arg: any): arg is PropsUIProgressBar;
...
export declare function isPropsUIPagination(arg: any): arg is PropsUIPagination;
...
export declare function isPropsUITablePage(arg: any): arg is PropsUITablePage;
export interface PropsUITableCard {
    __type__: 'PropsUITableCard';
    headCells: PropsUITableCell[];
    row: PropsUITableRow;
}
export declare function isPropsUITableCard(arg: any): arg is PropsUITableCard;
export interface PropsUITableCardItem {
    __type__: 'PropsUITableCardItem';
    title: PropsUITableCell;
    description: PropsUITableCell;
}
export declare function isPropsUITableCardItem(arg: any): arg is PropsUITableCardItem;
